# Django settings for sinkmb project.

from djangoappengine.settings_base import *
import private.settings, os

PROJECT_PATH = os.path.abspath( os.path.dirname( __file__ ) )
PRIVATE_SETTINGS = private.settings.load( PROJECT_PATH )
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'main.context_processors.entrances',
)
...
SERVER_MAIL = PRIVATE_SETTINGS['SERVER_MAIL']
...
SERVICES = PRIVATE_SETTINGS['SERVICES']
